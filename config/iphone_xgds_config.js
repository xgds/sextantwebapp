...
module.exports = {
    ...
    server : { port : 3001,
    		   ...
    		   name : '10.132.6.224', //TODO REPLACE THIS WITH YOUR IP ADDRESS 
    ...
    kml_urls : ['https://10.132.6.224/notes/notesFeed.kml',
    	           'https://10.132.6.224/basaltApp/hvnp_so2.kml'], //TODO REPLACE THIS WITH YOUR IP ADDRESS
